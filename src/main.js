...
const MIN_BLACK = 100;          // fast instant load transition
...
function degrade(reason) {
  ...
  document.querySelector('.stage-wrap').insertAdjacentHTML('afterbegin',
    '<div class="fallback"><p>VIGNESH</p>'
...
// Explicit navigation handler for links
document.querySelectorAll('a[href]').forEach((a) => {
  const href = a.getAttribute('href');
  if (href && (href === 'work.html' || href.endsWith('work.html'))) {
