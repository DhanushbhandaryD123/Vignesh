...
export class Furniture {
  constructor(root = document) {
    ...
    this.dotsTL = root.getElementById('dotsTL');
  ...
  _build() {
    ...
    for (const box of [this.dotsBR, this.dotsTL].filter(Boolean)) {
      box.innerHTML = '';
  ...
  apply(L) {
    ...
    s.setProperty('--dots-tl-x', `${w * REF.dotsTL.x}px`);
    s.setProperty('--dots-tl-y', `${h * REF.dotsTL.y}px`);
